...
<configurationSectionModel xmlns:dm0="http://schemas.microsoft.com/VisualStudio/2008/DslTools/Core" dslVersion="1.0.0.0" Id="d0ed9acb-0435-4532-afdd-b5115bc4d562" namespace="PalMon" xmlSchemaNamespace="PalMon" xmlns="http://schemas.microsoft.com/dsltools/ConfigurationSectionDesigner">
  <typeDefinitions>
  ...
  <configurationElements>
    <configurationSection name="PalMonConfig" namespace="PalMon.Config" codeGenOptions="Singleton, XmlnsProperty" xmlSectionName="PalMonConfig">
      <elementProperties>
    ...
    <configurationElementCollection name="Cluster" namespace="PalMon.Config" documentation="Represents a logical grouping of hosts." xmlItemName="Host" codeGenOptions="Indexer, AddMethod, RemoveMethod, GetItemMethods">
      <attributeProperties>
    ...
    <configurationElement name="Database" namespace="PalMon.Config" documentation="Contains configuration information for the results database.  Only required if OutputMode is &quot;DB&quot;.">
      <attributeProperties>
        ...
        <attributeProperty name="Name" isRequired="true" isKey="false" isDefaultCollection="false" xmlName="name" isReadOnly="false" documentation="The name of the instantiated database." defaultValue="&quot;PalMon&quot;">
          <validator>
            <stringValidatorMoniker name="/d0ed9acb-0435-4532-afdd-b5115bc4d562/NonEmptyString" />
          </validator>
          <type>
    ...
    <configurationElement name="Host" namespace="PalMon.Config" documentation="Represents an individual host.">
      <attributeProperties>
    ...
    <configurationElement name="Server" namespace="PalMon.Config" documentation="Contains information about the database server location.">
      <attributeProperties>
    ...
    <configurationElement name="Table" namespace="PalMon.Config" documentation="Contains information about the results table.">
      <attributeProperties>
    ...
    <configurationElement name="PollInterval" namespace="PalMon.Config" documentation="Contains information about the polling frequency.">
      <attributeProperties>
    ...
    <configurationElement name="OutputMode" namespace="PalMon.Config" documentation="Contains information about the result output mode.">
      <attributeProperties>
    ...
    <configurationElementCollection name="Clusters" namespace="PalMon.Config" documentation="Contains definitions of which machines to monitor and their logical clustering.  Each cluster may contain multiple hosts." xmlItemName="Cluster" codeGenOptions="Indexer, AddMethod, RemoveMethod, GetItemMethods">
      <itemType>
