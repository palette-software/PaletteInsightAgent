...
![Insight Server Control Page](https://github.com/palette-software/PaletteInsightAgent/blob/install-guide/docs/resources/insight-server-control-page.png?raw=true)
...
Another way to obtain the .msi is from this repo's Releases folder:
https://github.com/palette-software/PaletteInsightAgent/releases
